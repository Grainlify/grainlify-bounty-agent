...
const COLS: [keyof InferenceCallRecord, string][] = [
  ...
  ['payerWallet', 'payer_wallet'], ['payTxSignature', 'pay_tx_signature'], ['paidMicro', 'paid_micro'], ['feeLamports', 'fee_lamports'], ['feeMicro', 'fee_micro'],
...
const NUM_COLS = new Set(['quote_cap_micro', 'paid_micro', 'fee_lamports', 'fee_micro', 'charged_micro']);
